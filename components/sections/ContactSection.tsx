      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 items-start">
          ...
          >
            ...
            {isSubmitted ? (
              <div className="text-center p-6 bg-green-50 dark:bg-green-700/30 text-green-700 dark:text-green-200 rounded-lg">
                <h4 className="font-semibold text-lg mb-2">ההודעה נשלחה בהצלחה!</h4>
              ...
              <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6">
                <div>
                  ...
                  <input type="text" name="name" id="name" value={formData.name} onChange={handleInputChange} required className="w-full px-4 py-2.5 sm:py-3 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm focus:ring-2 focus:ring-primary focus:border-primary dark:bg-secondary dark:text-white transition-all duration-200 placeholder:text-gray-400 dark:placeholder:text-gray-500" placeholder="לדוגמה: ישראל ישראלי" />
                </div>
                <div>
                  ...
                  <input type="email" name="email" id="email" value={formData.email} onChange={handleInputChange} required className="w-full px-4 py-2.5 sm:py-3 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm focus:ring-2 focus:ring-primary focus:border-primary dark:bg-secondary dark:text-white transition-all duration-200 placeholder:text-gray-400 dark:placeholder:text-gray-500" placeholder="your@email.com" />
                </div>
                <div>
                  ...
                  <textarea name="message" id="message" value={formData.message} onChange={handleInputChange} rows={4} required className="w-full px-4 py-2.5 sm:py-3 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm focus:ring-2 focus:ring-primary focus:border-primary dark:bg-secondary dark:text-white transition-all duration-200 placeholder:text-gray-400 dark:placeholder:text-gray-500" placeholder="כתבו את פנייתכם כאן..."></textarea>
                </div>
                <div>
                  <Button type="submit" variant="primary" className="w-full text-base sm:text-lg py-3 shadow-lg hover:shadow-xl" icon={<Send size={18} />}>
                    שליחה
                  </Button>
                </div>
              </form>
