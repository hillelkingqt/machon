...
import { CalendarDays, UserCircle, Tag, ArrowLeft, Edit3, Share2, ChevronsLeft, Award, SearchX } from 'lucide-react'; // Changed ArrowRight to ArrowLeft, ChevronsLeft for RTL
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 my-10 sm:my-14 md:my-20">
                ...
                >
                    ...
                    <header className="mb-10 sm:mb-12 md:mb-14">
                        ...
                        {/* Apply H1 styling directly here, remove h1-article-style class if not used elsewhere */}
                    ...
                    <AnimatedDiv animation="fadeInUp" delay={0.55}>
                        <article
                            className="prose prose-lg dark:prose-invert max-w-none" // Keep this for now
